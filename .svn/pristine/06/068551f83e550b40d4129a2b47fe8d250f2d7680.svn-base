<template>
  <div class="transportService_container">
    ...
    <div class="form_container">
      <div class="form_item patient boldUnderline" @click="selectPatient">
    ...
    <div class="button_container">
      ...
      <div class="order_immediately">立即下单</div>
    </div>
  </div>
</template>
