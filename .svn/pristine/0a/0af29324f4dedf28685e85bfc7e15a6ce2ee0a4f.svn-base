  ...
  export default {
    ...
    data() {
      return {
        ...
        identifier:'4816104082297856',   //用户id
        userSig:'',
        textMsg: '',  //文本内容
        oddtime:'',
        zxinfo:'',
    ...
    methods: {
      ...
      getinfo(){
        ...
        getuserfree(fromId,4874370812023808,this.freetalktype).then((res)=>{
      ...
      onSendTextMsg() {
        ...
        let topeople='4874370812023808';
        //let topeople=this.consultuserId+'';//'4874370812023808';
