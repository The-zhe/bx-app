<template>
  <div class="reportUnscramble_container">
    ...
    <div class="form_container">
      ...
      <div class="form_item reportUpload boldUnderline">
        <div class="label">*报告上传：</div>
