 ...
 * @Last Modified time: 2020-01-17 11:35:33
 */

<template>
  <div class="inspectionDetail_container" v-if="Object.keys(inspectionInfo).length>0">
    <div class="headerPart_container"></div>
    <div class="report_container">
      <div class="report_container_">
        <div class="report_header">
          <div class="hospital">{{inspectionInfo.hospName}}</div>
          <div class="date">{{inspectionInfo.opcDate.slice(0,10)}}</div>
        </div>
