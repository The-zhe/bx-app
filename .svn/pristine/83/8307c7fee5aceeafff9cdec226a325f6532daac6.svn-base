    ...
    <div class="check_advices">
        ...
        <div class="advices">
            <div class="advices_title">
               ...
               <div class="advices_details">健康状况类型</div>
            </div>
            <div class="divider"></div>
            <div class="advices_content">
                <textarea class="advices_box" placeholder="请填写健康状况建议" v-model="advices_input" cols="30" rows="22"></textarea>
            </div>
            <div class="advices_post_button">
                ...
                <van-button class="advices_button_commit advices_button" round  size="small">确定</van-button>
            </div>
        </div>
    </div>
</template>
...
import {pushAdvice} from '../../../api/apiz'
export default {
    ...
    methods:{
        pushAdvice(advices_input){
            pushAdvice(advices_input).then(res => {
                console.log(res)
            })
        }
    },
    mounted(){
        this.pushAdvice(this.advices_input)
    }
}
</script>
