<template>
  <div class="doorsChangedrug_container">
    ...
    <div class="form_container">
      ...
      <div class="form_item nurse boldUnderline" @click="selectNurse">
...
export default {
  ...
  mounted(){
    ...
    if(sessionStorage.getItem('nurseInfo')){
      this.doctorName=JSON.parse(sessionStorage.getItem('nurseInfo')).nurseName
      this.doctorId=JSON.parse(sessionStorage.getItem('nurseInfo')).nurseId
    }
