<template>
  <div class="doorsConsult_container">
    ...
    <div class="form_container">
      ...
      <div class="textarea_item consultAim">
        <div class="label">咨询目的：</div>
        <div class="input">
          <textarea rows="3" v-model="consultationPurpose" placeholder="请填写咨询目的" />
        </div>
      </div>
  ...
  methods: {
    ...
    submitForm(){
      postPrivateService({
        ...
        consultationPurpose:this.consultationPurpose,
