<template>
  <div class="doorsPhysical_container">
    ...
    <div class="form_container">
      ...
      <div class="form_item doctor boldUnderline" @click="selectTherapist">
        <div class="label">*理疗师：</div>
        <div class="val">{{therapist}}</div>
        <div class="rightArrow">
          <img :src="rightArrowIcon" />
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectTherapist(){
      this.$router_({name:'therapistList'})
    },
    selectPatient(){
  ...
  mounted(){
    ...
    if(sessionStorage.getItem('therapistInfo')){
      this.therapist=JSON.parse(sessionStorage.getItem('therapistInfo')).therapistName
      this.therapistId=JSON.parse(sessionStorage.getItem('therapistInfo')).therapistId
    }
  }
};
</script>
