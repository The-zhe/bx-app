<template>
    <div class="newsdetails">
        ...
        <div class="comments">
            <div class="hd_search">
                <input type="text" placeholder="写评论" v-model="comdata.cont" @blur="getvalue()">
...
import { getBannerNew,addCollection,addcommon } from '../../../api/apiz'
export default {
    name:'newsdetails',
    data(){
        return{
    ...
    methods:{
        ...
        getNews(){
            ...
            getBannerNew(this.newid,this.userId).then( res =>{
                console.log(res)
        ...
        toNews(id){
            ...
            this.$router.push({path:'/newsDetails',query: {id: this.newid,userId:this.userId}})
        },
        addCollect(){
